...
function Life() {
  ...
  let prevDate = new Date('2002-08-29')
        ...
        <PageSummary>
          ...
          <p>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              average life expectancy of a male living in India
            </a>
            ...
            <div key={year.toString()} className="grid gap-1 w-full relative">
              ...
              {year.map((week) => (
                <div
                  ...
                  className={`h-1 w-1 rounded-full sm:h-2 sm:w-2 border border-stone-400 ${isPast(week.date) ? 'bg-purple-500 border-none' : ''
                    }`}
                ></div>
              ))}
            </div>
